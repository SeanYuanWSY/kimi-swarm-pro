...
If you discover a security issue in `kimi-swarm` — especially anything related to the install/uninstall scripts modifying user files or API keys — please report it responsibly:

1. **Do NOT open a public issue.**
2. Use [GitHub Security Advisories](https://github.com/SeanYuanWSY/kimi-swarm/security/advisories/new) — this is the preferred and most reliable channel.
